...
export function FooterTest() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      {/* Spacer Content */}
      <div className="flex-1 flex items-center justify-center p-4 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Footer Preview</h1>
          <p className="text-muted-foreground text-lg">Scroll down to see the footer component</p>
        </div>
      </div>

      {/* Footer */}
      <footer className="bg-card border-t mt-12 py-8 md:py-12">
