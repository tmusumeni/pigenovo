/*
  Migration 31: SIMPLEST FIX - Match actual column types exactly
  
  Simply declare the function to return 'timestamp without time zone'
  since that's what the actual columns are.
  No casting needed.
*/
